...
const projectsData = [
  {
    title: 'MGS 2030 S',
    description: 'Alta-fidelidade artesanal: caixa desenvolvida do zero com ênfase em resposta equilibrada, baixa distorção e acabamento premium. A imagem mostra um dos primeiros protótipos finalizados e os detalhes de acabamento que definiram o produto.',
    imageURL: '/MGS-PHOTO.png',
    tags: ['Áudio', 'Prototipagem', 'Acústica', 'Produção Small-Batch'],
    github: 'https://github.com/mgv-technology',
  },
  {
    title: 'MSC 1000',
  ...
  },
  {
    ...
    description: 'São aqueles que, em maioria, não foram finalizados ou publicados, mas que contribuíram para o aprendizado e evolução da MGV Technology em áreas como áudio, eletrônica e desenvolvimento de software.',
    imageURL: '/archived.png',
    tags: ['Organização', 'Imobiliária', 'Sistemas'],
  },
  {
    title: 'La Bombonera Repository',
    description: 'Integração com a Web. Com o nosso novo site, centralizamos nossos projetos, serviços e portfólio em um único local, facilitando o acesso às informações sobre nossas soluções em tecnologia e inovação.',
    imageURL: '/site-exp.png',
    tags: ['Segurança', 'Tecnologia', 'Infraestrutura'],
    github: 'https://github.com/miguel-zacharias/La-Bombonera-Repository'
  },
  
  {
    title: 'Integração MGV Records',
    description: 'Projetos realizados para o Estúdio MGV Records, focados em produção musical, distribuição digital e produção.',
    imageURL: '/records.png',
  ...
  return (
    <section id="projects" className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 title="Nossos Projetos" className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-700 via-gray-500 to-gray-100 bg-clip-text text-transparent mb-4">
            Nossos Projetos
          </h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-3">
            Uma coleção de projetos inovadores que demonstram nossa experiência técnica e criatividade.
          </p>
